...
class state_estimator:
    ...
    def imu_cb(self, data):
        ...
        if self.init_step < self.init_max and not self.init:  # init for 0.05 second
            ...
            self.pos = [
                self.pos[0] + self.vel[0] * (self.imu_time - self.imu_old_time),
                self.pos[1] + self.vel[1] * (self.imu_time - self.imu_old_time),
                self.pos[2] + self.vel[2] * (self.imu_time - self.imu_old_time),
            ]
